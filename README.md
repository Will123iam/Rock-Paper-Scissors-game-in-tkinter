...
This will load a table with all previous saved scores. If you want to delete a score, simply click the one you would like to delete and press the backspace key.
Information stored within the table includes:
- Date
- Players score
- Computers score
- Overall winner
